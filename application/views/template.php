...
<head>
    ...
    <!-- Font Awesome CSS -->
    <link href="<?php echo base_url() ?>assets/src/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet"
        type="text/css" />
    ...
    <div id="main">
        ...
        <div class="headerbar">
            ...
            <div class="headerbar-left">
                <a href="<?= base_url('Home') ?>" class="logo"><img alt="Logo" src="assets/images/logo.png" />
                    <span>Admin</span></a>
            </div>
            ...
            <div class="sidebar-inner leftscroll">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="<?= base_url('Home') ?>"><i class="fa fa-fw fa-home"></i><span>
                                    Dashboard </span> </a>
                        </li>

                        <li class="submenu">
                            <a href="<?= base_url('User') ?>"><i class="fa fa-fw fa-users"></i><span>
                                    Users </span> </a>
                        </li>
        ...
        <footer class="footer">
            <span class="text-right">
                Copyright <a target="_blank" href="#">MSAL GROUP</a>
            </span>
            <span class="float-right">
                Powered by <a target="_blank" href="#"><b>MIS MSAL GROUP</b></a>
            </span>
        </footer>
